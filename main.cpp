...
int main(int argc, char* argv[]) {
	...
	std::cerr<<s.getFloor(1)<< " ";
	std::cerr<<s.getFloor(2)<<std::endl;

	s.setDirection(1,2);
	s.setDirection(2,1);

	std::cerr<<s.getDirection(1)<< " ";
	std::cerr<<s.getDirection(2)<<std::endl;

	s.turnOnElevatorButton(1,1);
	s.turnOnElevatorButton(1,2);

	std::cerr<<s.elevatorButtonPressed(1,1)<< " ";
	std::cerr<<s.elevatorButtonPressed(2,1)<<std::endl;

	s.turnOnFloorButton(1,0);
	s.turnOffFloorButton(1,1);

	std::cerr<<s.floorButtonPressed(1,0)<< " ";
	std::cerr<<s.floorButtonPressed(1,1)<<std::endl;
